...
output_model_path = '/data/zyd/codes/spatial-temporal/outputs/0509/models'
...
weather5k_params = {
    ...
    "root_dirs": ['/data/zyd/data/weather_5k/WEATHER-5K/global_weather_stations_npy_2_test','/data/zyd/data/all_1.40625deg/2m_temperature_graph_npy_2_test'],
    "input_variables": ["TMP"],
...
trainer = Trainer(
    ...
    experiment=experiment,
    # model_params='/data/zyd/codes/spatial-temporal/outputs/0509/models/model_epoch=49_RMSE=2.329767.pth',
    predict_path='/data/zyd/codes/spatial-temporal/outputs/0509'
)
