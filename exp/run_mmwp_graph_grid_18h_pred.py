...
output_model_path = '/data/zyd/codes/spatial-temporal/outputs/0510_18h/models'
...
trainer = Trainer(
    ...
    experiment=experiment,
    model_params='/data/zyd/codes/spatial-temporal/outputs/0511_18h/models/model_epoch=46_RMSE=210.761248.pth',
    predict_path='/data/zyd/codes/spatial-temporal/outputs/0511_18h'
)
