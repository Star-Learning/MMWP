...
output_model_path = '/data/zyd/codes/spatial-temporal/outputs/0510_12h/models'
...
trainer = Trainer(
    ...
    experiment=experiment,
    model_params='/data/zyd/codes/spatial-temporal/outputs/0511_12h/models/model_epoch=46_RMSE=205.645668.pth',
    predict_path='/data/zyd/codes/spatial-temporal/outputs/0511_12h'
)
