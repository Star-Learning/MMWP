...
output_model_path = '/data/zyd/codes/spatial-temporal/outputs/0510_48_168_simple/models'
os.makedirs(output_model_path, exist_ok=True)

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")


time_slice_train_grid = ("2014-01-01", "2016-12-31") 
time_slice_val_grid = ('2017-01-01', '2017-12-31') 
time_slice_test_grid = ('2018-01-01', '2018-12-31') 

time_slice_train_graph = ("2014-01-01", "2017-01-01")
time_slice_val_graph = ('2017-01-01', '2018-01-01') 
time_slice_test_graph = ('2018-01-01', '2019-01-01') 
...
graph_dataset_train = None
graph_dataset_val = None
...
grid_dataset_train = None
grid_dataset_val = None
grid_dataset_test = GridDatasetAll(time_slice=time_slice_test_grid, **weatherbench_params)


weather_dataset_train = None
weather_dataset_val = None
...
trainer = Trainer(
    ...
    experiment=experiment,
    model_params='/data/zyd/codes/spatial-temporal/outputs/0510_48_168_simple/models/model_epoch=50_RMSE=525.095840.pth',
    predict_path='/data/zyd/codes/spatial-temporal/outputs/0510_48_168_simple'
)
