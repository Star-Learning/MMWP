...
output_model_path = '/data/zyd/codes/spatial-temporal/outputs/0510_6h/models'
...
trainer = Trainer(
    ...
    experiment=experiment,
    model_params='/data/zyd/codes/spatial-temporal/outputs/0511_6h/models/model_epoch=49_RMSE=194.650143.pth',
