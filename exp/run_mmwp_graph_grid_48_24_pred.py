...
output_model_path = '/data/zyd/codes/spatial-temporal/outputs/0510_48_24_simple/models'
...
trainer = Trainer(
    ...
    experiment=experiment,
    model_params='/data/zyd/codes/spatial-temporal/outputs/0510_96_96_mlp/models/model_epoch=46_RMSE=210.557162.pth',
    predict_path='/data/zyd/codes/spatial-temporal/outputs/0510_48_24_simple'
)
